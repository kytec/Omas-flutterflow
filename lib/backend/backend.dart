...
import 'schema/findpharma_record.dart';
...
export 'schema/findpharma_record.dart';
...
/// Functions to query FindpharmaRecords (as a Stream and as a Future).
Future<int> queryFindpharmaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FindpharmaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FindpharmaRecord>> queryFindpharmaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FindpharmaRecord.collection,
      FindpharmaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FindpharmaRecord>> queryFindpharmaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
